...
with open(os.path.join(this_directory, 'PlotMAPQ', '_version.py'), 'wt') as fversion:
...
setuptools.setup(
    name="MAPQTools",                                           # name of project
    ...
    author="Alyssa Morrow",                                     # Author, shown on PyPI
    scripts = ['bin/plot-mapq'],                                # command line scripts installed
    author_email="akmorrow@berkeley.edu",                       # Author email
